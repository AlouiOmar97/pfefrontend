...
import { FaAngleRight, FaAngleDown, FaChartPie } from 'react-icons/fa';
import { MdDashboard, MdWarning } from 'react-icons/md';
import { Link, NavLink, useLocation } from "react-router-dom";
import { ImFlag } from 'react-icons/im';
import { GiAlarmClock } from 'react-icons/gi';
import { RiChatSmileFill, RiGlobeFill } from 'react-icons/ri'
import { HiUserAdd, HiLockClosed } from 'react-icons/hi'
...
const SideBarBack = () => {
    ...
    function onToggle(e) {
        setBool({ value: !bool.value })
        console.log("toggle : " + bool.value);
    }
    return (
        <>
                ...
                <section class="sidebar position-relative">
                    <div class="d-flex align-items-center logo-box justify-content-start d-md-block d-none">
                        ...
                        <a href="index-2.html" class="logo">
                            {/* <!-- logo--> */}
                            <div class="logo-mini">
                                <span class="light-logo"><img src="assets/backoffice/images/logo-letter.png" alt="logo" /></span>
                            </div>
                            <div class="logo-lg">
                    ...
                    <div class="user-profile my-15 px-20 py-10 b-1 rounded10 mx-15">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="image d-flex align-items-center">
                                <img src="assets/backoffice/images/avatar/avatar-13.png" class="rounded-0 me-10" alt="User Image" />
                                <div>
                    ...
                    <div class="multinav">
                        <div class="multinav-scroll" /* style="height: 97%;" */ style={{ '&::-webkit-scrollbar': { width: 0, }, height: "97%", overflow: "auto" }}>
                            {/* <!-- sidebar menu--> */}
                            <ul class="sidebar-menu" data-widget="tree">
                                ...
                                <li className={splitLocation[1] === "" ? "active" : ""}>
                                    <Link to="/">
                                        <MdDashboard
                                            style={{ fill: splitLocation[1] === "" ? "#7047ee" : "#2f415e" }}
                                        ></MdDashboard>
                                        <span>Dashboard</span>
                                    </Link>
                                </li>
                                <li>
                                    <a href="analytics.html">
                                        <FaChartPie
                                            style={{ fill: splitLocation[1] === "analytics" ? "#7047ee" : "#2f415e" }}
                                        ></FaChartPie>
                                        <span>Analytics</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="reports.html">
                                        <ImFlag
                                            style={{ fill: splitLocation[1] === "report" ? "#7047ee" : "#2f415e" }}
                                        ></ImFlag>
                                        <span>Reports</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="extra_calendar.html">
                                        <GiAlarmClock
                                            style={{ fill: splitLocation[1] === "calendar" ? "#7047ee" : "#2f415e" }}
                                        ></GiAlarmClock>
                                        <span>Calendar</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="contact_app_chat.html">
                                        <RiChatSmileFill
                                            style={{ fill: splitLocation[1] === "chat" ? "#7047ee" : "#2f415e" }}
                                        ></RiChatSmileFill>
                                        <span>Chat</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="contact_userlist_grid.html">
                                        <HiUserAdd
                                            style={{ fill: splitLocation[1] === "add" ? "#7047ee" : "#2f415e" }}
                                        ></HiUserAdd>
                                        <span>Contacts</span>
                                    </a>
                                </li>
